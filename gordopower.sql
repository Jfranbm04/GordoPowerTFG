...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-06-2025 a las 12:29:49
...
(1, 'Croquetas', 'Croquetas de cocido', 'spain', 100, 'legendary', 'entrante', 50, 30, 'uploads/food/croquetas.png'),
(3, 'Sushi', 'Sushi fresco', 'Japan', 75, 'Epic', 'principal', 15, 15, 'uploads/food/sushi.png'),
...
(3, 'admin@admin.com', '[\"ROLE_ADMIN\"]', '$2y$13$y9bYubGE3wawI7eGi4Inue6aLmS5/IYC/IGeDgFQhfq3wvFsmLWLy', 'admin', 56000, 1),
(4, 'ancelotti@hotmail.com', '[\"ROLE_USER\"]', 'javi', 'javi', 900, 1),
(5, 'marcosherediasalazar@gmail.com', '[\"ROLE_USER\"]', '123456', 'Marcos Heredia Salazar', 320, 1),
(6, 'javi@javi.com', '[\"ROLE_USER\"]', 'javi', 'javi', 625, 1),
(7, 'dinoestufa@gmail.com', '[\"ROLE_USER\"]', '$2y$13$s8/vSbsXzE3dNKraEz7qSuy4Lro0MroyTz2giVG27vGKxwYw7q.ie', 'dinoestufa', 10000, 1),
(8, 'asdasd@asd.com', '[\"ROLE_USER\"]', '$2y$13$y9bYubGE3wawI7eGi4Inue6aLmS5/IYC/IGeDgFQhfq3wvFsmLWLy', 'asd', 1000, 1),
(9, 'ejemplo@ejemplo.com', '[\"ROLE_USER\"]', '$2y$13$QXNiB4AqzqjQz8uOpxNuOugOJ3OKmh3Y1Dg6Qac9OE62JO46WnoMq', 'ejemplo', 10000, 1);
